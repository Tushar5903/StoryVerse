...
export function Meter({ reviews, compact = false }) {
  const gaugeCx = compact ? 85 : 170, gaugeCy = compact ? 85 : 170, gaugeRadius = compact ? 70 : 140, gaugeStroke = compact ? 8 : 14, gapAngle = 6
